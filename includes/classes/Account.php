...
class Account {
    ...
    public function updatePassword($oldPw, $pw, $pw2, $un) {  // UPDATES NEW PASSWORD IN DATABASE
    ...
    public function validateOldPassword($oldPw, $un) {  // CHECKS IF THE OLD PASWORD MATCHES THE ONE IN THE DATABASE
